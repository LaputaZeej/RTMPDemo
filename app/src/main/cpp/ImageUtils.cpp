...
Java_com_bugull_rtmp_camera_ImageUtils_rotation(JNIEnv *env, jclass thiz, jbyteArray data_, jint width,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_bugull_rtmp_camera_ImageUtils_scale(JNIEnv *env, jclass clazz, jbyteArray src_, jbyteArray dst_,
                                       jint srcWidth,
